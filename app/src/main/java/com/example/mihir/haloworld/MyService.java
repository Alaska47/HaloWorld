...
public class MyService extends Service
{
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
            ...
            SharedPreferences pref = getSharedPreferences("com.example.mihir.haloworld", MODE_PRIVATE);
            Socket register = null;
            try {
                register = new Socket(host, portNumber);
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            if(!loc.equals(lastLoc))
                out.println("updateloc," + LoginActivity.phonenumber + "," + loc + "\n");
            try {
                register.close();
            } catch (IOException e) {
                e.printStackTrace();
